    ...
    return (
        <div className="container mb-5 padre">
            ...
            <div >
                ...
                <form className="formProduct">
                    <div className="div-title">
                        ...
                        <input type="text" name="title" value={input.title} onChange={handleChange} className="form-control form-control-lg escribir" required />
                        <div id="emailHelp" class="form-text">Es el primer contacto que el consumidor tiene con tu producto en el ambiente online </div>
                    </div>

                    {/* PRECIO */}

                    <div className="div-title col-1">
                    ...
                    <div>
                        ...
                        <div id="emailHelp" class="form-text">Afectan la forma en que el producto se muestra a los clientes, te facilitan la organización de tus productos y ayudan a los clientes a encontrar el producto
                        </div>
                    </div>
            ...
            <div>
                ...
                <button type="submit" className="btn btn-success ml-5 mt-4" onClick={(e) => alert("producto creado")}>Guardar</button>
            </div>
        </div>
